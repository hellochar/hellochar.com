...
export const ExplodeShader = {
    ...
    fragmentShader: [
        ...
        "        float factor = 1. / (i + 1.0);",
        "        col.r += explodedTexture2D(center, shrink).r * factor;",
        "        shrink *= shrinkFactor;",
        "        col.g += explodedTexture2D(center, shrink).g * factor;",
        "        shrink *= shrinkFactor;",
        "        col.b += explodedTexture2D(center, shrink).b * factor;",
        "        shrink *= shrinkFactor;",
        "        center -= m2*(center - vec2(0.5))*scalar;",
        "    }",
